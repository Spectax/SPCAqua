...
urlpatterns = patterns('',
    ...
    url(r'^companybill/search/$', 'spcaqua.views.search_company_bill', name='searchcompanybill'),
    url(r'^purchasebill/search/$', 'spcaqua.views.search_purchase_bill', name='searchpurchasebill'),
    url(r'^lot/search/$', 'spcaqua.views.search_lot', name='searchlot'),
